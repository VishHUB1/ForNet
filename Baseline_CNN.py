...
class ForNetAudioClassifier:
    ...
    def load_audio_data(self):
        ...
        # The three main classes should be: Animals, Anomalous, Nature
        expected_classes = ['Animals', 'Anomalous', 'Nature']
        found_classes = []
        ...
        for class_name in os.listdir(self.data_dir):
            ...
            if os.path.isdir(class_path):
                ...
                # Process all subdirectories within each class
                subdirs_found = 0
                files_found = 0
                        ...
                        for file_name in os.listdir(subdir_path):
                            if file_name.endswith(('.wav', '.mp3', '.flac', '.m4a')):
                                ...
                                try:
                                    ...
                                    self.labels.append(
                                        class_name)  # This assigns the main class (Animals/Anomalous/Nature)
...
def main():
    # Configuration
    DATA_DIR = r"C:\Users\visha\Desktop\forest_research\FSC22_classes"  # Update this path to your dataset directory
    RESULTS_DIR = "C:/Users/visha/Desktop/forest_research/Baseline_CNN_results"
